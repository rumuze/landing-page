            ...
            {sortedThreads.map((thread, index) => {
              ...
              return (
                ...
                >
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          {thread.userPhoto ? (
                            ...
                            <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-sm font-semibold text-cyan-400">
                  ...
                  <p className={`mt-4 text-sm leading-6 truncate ${isUnread ? "text-white font-medium" : "text-slate-400"}`}>
