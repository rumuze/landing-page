...
const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen py-24 bg-slate-50 dark:bg-transparent transition-colors duration-300 relative overflow-hidden">
      {/* Background Decor */}
      <div className={`absolute top-0 w-[500px] h-[500px] bg-cyan/5 rounded-full blur-[100px] ${isRtl ? '-left-64' : '-right-64'}`} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          >
            ...
            <div className="space-y-8">
              <a href="mailto:connect@rumuze.com" className="flex items-center gap-6 group">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white text-lg">{t('contact.info.email')}</h3>
                  <p className="text-slate-600 dark:text-gray-400 group-hover:text-cyan transition-colors">connect@rumuze.com</p>
                </div>
              </a>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white text-lg">{t('contact.info.phone')}</h3>
              ...
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  <h3 className="font-bold text-slate-900 dark:text-white text-lg">{t('contact.info.hq')}</h3>
                  <p className="text-slate-600 dark:text-gray-400">Obour City, Cairo, EG</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-slate-200 dark:border-white/10">
              <div className="flex gap-4">
                <a href="#" className="p-3 rounded-full bg-white dark:bg-white/5 text-slate-600 dark:text-gray-400 hover:text-cyan hover:shadow-lg hover:shadow-cyan/20 transition-all border border-slate-200 dark:border-white/10">
                  <Linkedin size={20} />
                </a>
                <a href="#" className="p-3 rounded-full bg-white dark:bg-white/5 text-slate-600 dark:text-gray-400 hover:text-cyan hover:shadow-lg hover:shadow-cyan/20 transition-all border border-slate-200 dark:border-white/10">
                  <Github size={20} />
            ...
            <AnimatePresence>
              {success ? (
                ...
                >
                  ...
                  <p className="text-slate-600 dark:text-gray-400 max-w-xs">{t('contact.success')}</p>
                  <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-500 pl-1">{t('contact.labels.name')}</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-500 pl-1">{t('contact.labels.company')}</label>
                    <input 
                      type="text" 
                      name="company"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-500 pl-1">{t('contact.labels.email')}</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-500 pl-1">{t('contact.labels.subject')}</label>
                    <input 
                      type="text" 
                      name="subject"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase tracking-widest text-slate-500 dark:text-gray-500 pl-1">{t('contact.labels.message')}</label>
