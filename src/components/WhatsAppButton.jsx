...
/**
 * WhatsAppButton — Bare button element.
 *
 * Positioning is handled by the parent FloatingStack in App.jsx.
 * Returns null on executive pages (suppressed paths).
 * Icon-only, neutral styling, no animation.
 */

const WHATSAPP_NUMBER = '201000061409';
...
const WhatsAppButton = ({ className = '', showTooltip = true }) => {
  ...
  const prefillMessage = encodeURIComponent(t('whatsapp.prefillMessage'));
  const href = `https://wa.me/${WHATSAPP_NUMBER}?text=${prefillMessage}`;
