               ...
               {projects.map(item => item.id === selectedId && (
                  ...
                  >
                     ...
                     <div className="p-8">
                        ...
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-3">{item.title}</h2>
                        <p className="text-lg text-slate-600 dark:text-gray-300 mb-8 leading-relaxed">{item.description}</p>
